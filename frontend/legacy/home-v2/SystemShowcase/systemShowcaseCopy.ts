...
export const systemShowcaseCopy = {
  ...
  secondary: { label: 'Referansları inceleyin', route: 'references' },
  sceneNote: 'Temsilî görsel: kiosk, gerçek bir otopark çıkışı fotoğrafına yerleştirilmiştir.',
  flowLabel: 'Çıkış işlem akışı',
  pause: 'Çıkış işlem akışını duraklat',
  play: 'Çıkış işlem akışını oynat',
  pauseShort: 'Duraklat',
  playShort: 'Oynat',
  features: [
    {
...
export const sceneImages = {
  ...
  kiosk: {
    alt: 'Otopark çıkışına yerleştirilmiş insansız çıkış ödeme kiosku (temsilî görsel; ön paneli banka iş birliğiyle kurumsal giydirmeli örnek)',
    width: 274,
    height: 1040,
