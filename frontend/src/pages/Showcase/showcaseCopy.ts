...
export const showcaseCopy: Record<ShowcaseRoute, ShowcaseCopy> = {
  ...
  'mobil-abonelik': {
    ...
    lead: 'Mobil uygulamamız üzerinden saniyeler içinde abonelik işlemlerinizi tamamlayın.',
    paragraphs: ['Mobil uygulamamız üzerinden saniyeler içinde abonelik işlemlerinizi tamamlayın.'],
    images: [{ src: '/img/pages/app-abonelik-sec-crop.webp', alt: 'Uygulamada abonelik seçimi ekranı' }],
    cta: 'Hemen Teklif Alın',
    ctaRoute: 'quote.index',
    jump: { id: 'nasil-yapilir', label: 'Nasıl yapılır?' },
    ctaBand: {
      eyebrow: 'Mobil abonelik',
      title: 'Aboneliği uygulamaya taşıyın.',
      description: 'Mobil abonelik ve borç ödeme akışını otoparkınıza uyarlayalım.',
      secondary: { label: showcaseShared.softwareCta, route: 'software-products' },
    },
    ...
    ogImage: '/img/pages/app-abonelik-sec-crop.webp',
  },
  'designer-tool': {
