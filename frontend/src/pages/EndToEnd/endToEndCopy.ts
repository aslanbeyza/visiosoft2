...
export const endToEndCopy = {
  ...
  modules: [
    ...
    },
    {
      ...
      mark: 'VK',
      title: 'Visio Kart',
      desc: 'Kart Yetkilendirme ve Yönetim',
    ...
    },
    {
      ...
      desc: 'Kullanıcı ve Abone Yönetimi',
    ...
    },
    {
      ...
      mark: 'VP',
      title: 'Visio Portal',
      desc: 'GİB ve Şarj için EPDK Entegrasyonu',
      detail:
