...
export type SceneState = {
  ...
  screen: number
  /** Bariyer kolu açısı (derece, 0 kapalı … −80 açık). */
  arm: number
 ...
 * LED panel çerçevesinin dış çizgisinden (x 88) bariyer kolunun ucuna (x 1150) ve kalkık kolun tepesinden (y ~100)
...
/** Bariyer kapalıyken aracın durduğu son konum (ön tampon direğe değmez). */
export const CAR_STOP = 745
export const ARM_OPEN = -80
